                                    ...
                                    <ul className="text-gray-600 mt-2">
                                        ...
                                        <li className="p-2 hover:bg-gray-200 cursor-pointer border-b w-full">
                                            <p className="flex flex-wrap md:flex-nowrap justify-between items-center gap-2">
                                                <span className="text-sm md:text-base">GPU IP Address</span>
                                                        ...
                                                        onBlur={() => {
                                                            setTimeout(() => {
                                                                if (
                                                                    ...
                                                                    (document.activeElement !== document.getElementById("app-ip") &&
                                                                        document.activeElement !== document.getElementById("gpu-ip"))
                                                                ) {
                                                                    setIsEditing(false);
                                                                }
                                                            }, 200);
                                            ...
                                            <p className="flex flex-wrap md:flex-nowrap justify-between items-center gap-2 mt-2">
                                                <span className="text-sm md:text-base">App IP Address</span>
                                        ...
                                        {/* <li className="p-2 border-b">
                                            ...
                                            {wmsUrl !== originalUrl && (isInputActive || !saved) && (
                                                <button
                                                    onClick={handleSave}
