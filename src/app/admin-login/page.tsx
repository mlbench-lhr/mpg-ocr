        ...
        <div className="flex min-h-screen items-center justify-center bg-[url('/images/bg.jpg')] bg-cover bg-center">
            <div className="w-full max-w-md bg-white rounded-sm shadow-lg p-6 mx-5">
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button
                        type="submit"
                        className={`w-full bg-[#005B97] text-white py-2 px-4 mt-5 font-bold rounded-md hover:bg-[#005b97f0] transition duration-300 ${loading ? "opacity-50 cursor-not-allowed" : ""
                            }`}
                        disabled={loading}
                    >
